    ...
    for instr in text.split("\n"):
        ...
        if decoding[0][0] != ".":
            ...
            if cur_opcode == Opcode.MOV:
                ...
                assert is_register(command_arguments[0]), f"MOV first argument should be register {command_arguments}"
            ...
            if cur_opcode in [Opcode.ADD, Opcode.MOD, Opcode.DIV, Opcode.CMP, Opcode.SUB, Opcode.TEST]:
            ...
            if cur_opcode == Opcode.LD:
                ...
                assert is_register(command_arguments[1][1:-1]), f"Not registers in arguments {command_arguments}"
            ...
            if cur_opcode == Opcode.ST:
                ...
                assert is_register(command_arguments[0][1:-1]), f"Not registers in arguments {command_arguments}"
                assert is_register(command_arguments[1]), f"Not registers in arguments {command_arguments}"
